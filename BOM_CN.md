...
> [!TIP]  
> 虽然每个机器人爱好者都应该至少亲手组装一次，但您可以以更高的价格购买[预组装套件](https://github.com/TheRobotStudio/SO-ARM100#kits)用于SO100/SO101机械臂。SO100机械臂需要最多的组装时间——两个机械臂大约需要4-6小时。一旦机械臂完成，剩余的组装只需要1-2小时。
