...
- **Plataforma de simulación** (mi preferencia personal): [Maniskill](https://www.maniskill.ai/)
    ...
    - 🤖Soporte para [múltiples robots](https://maniskill.readthedocs.io/en/latest/software/index.html) (incluyendo [brazo SO100](https://x.com/Stone_Tao/status/1910101218241978537))
